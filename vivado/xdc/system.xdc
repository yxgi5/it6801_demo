...
# IT6801 data
#G
set_property PACKAGE_PIN B14 [get_ports {vid_data[0]}]
set_property PACKAGE_PIN A14 [get_ports {vid_data[1]}]
set_property PACKAGE_PIN B13 [get_ports {vid_data[2]}]
set_property PACKAGE_PIN A13 [get_ports {vid_data[3]}]
set_property PACKAGE_PIN E14 [get_ports {vid_data[4]}]
set_property PACKAGE_PIN E13 [get_ports {vid_data[5]}]
set_property PACKAGE_PIN F12 [get_ports {vid_data[6]}]
set_property PACKAGE_PIN F11 [get_ports {vid_data[7]}]
#B
set_property PACKAGE_PIN J14 [get_ports {vid_data[8]}]
set_property PACKAGE_PIN H13 [get_ports {vid_data[9]}]
set_property PACKAGE_PIN H14 [get_ports {vid_data[10]}]
set_property PACKAGE_PIN F13 [get_ports {vid_data[11]}]
set_property PACKAGE_PIN G13 [get_ports {vid_data[12]}]
set_property PACKAGE_PIN L14 [get_ports {vid_data[13]}]
set_property PACKAGE_PIN C14 [get_ports {vid_data[14]}]
set_property PACKAGE_PIN C13 [get_ports {vid_data[15]}]
#R
